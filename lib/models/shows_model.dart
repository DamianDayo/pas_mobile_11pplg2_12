...
List<Shows> showsFromJson(String str) => List<Shows>.from(json.decode(str).map((x) => Shows.fromJson(x)));

String showsToJson(List<Shows> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
